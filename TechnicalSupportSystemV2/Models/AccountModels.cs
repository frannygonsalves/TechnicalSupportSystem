...
namespace TechnicalSupportSystem.Models
{
    ...
    public class UserProfile
    {
        ...
        public virtual IEnumerable<Supervisor> Supervisors { get; set; }
    ...
    public class RegisterModel
    {
        ...
        [Required]
        [StringLength(50, ErrorMessage = "First name cannot be longer than 50 characters and be Less than 2 Characters", MinimumLength = 2)]
        ...
        [StringLength(50, ErrorMessage = "Last name cannot be longer than 50 characters and be Less than 2 Characters", MinimumLength = 2)]
